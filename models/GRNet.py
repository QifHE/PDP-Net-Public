...
class GRNet(torch.nn.Module):
    def __init__(self):
        ...
        self.num_pred = 2048
        self.gridding_scale = [128]
        self.gridding_alpha = [0.1]
        self.loss_lambda = 0.
    ...
    def build_loss_func(self):
        self.loss_func_1 = ChamferDistance()
        self.loss_func_2 = GriddingLoss(
                        self.gridding_scale,
                        self.gridding_alpha)

    def get_loss(self, coarse, fine, gt):
        loss_coarse = self.loss_func_1(coarse, gt) + self.loss_func_2(coarse, gt) * self.loss_lambda
        loss_fine = self.loss_func_1(fine, gt)
    ...
    def forward(self, xyz):
        ...
        return sparse_cloud * 2.0, dense_cloud * 2.0
