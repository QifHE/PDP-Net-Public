...
from pcutils import (add_rotation_to_pcloud, augmented_normalize,
                     get_rotation_x, get_rotation_z, make_holes_base,
                     make_holes_horizontally, make_holes_pcd_2,
                     make_holes_pcd_3, normalize)
...
shapenet_part_dir = '../data/shapenet_part'
