...
def make_holes_pcd_percentage(pcd, percentage=0.5):
    ...
    for i in range(npoint):
        if i < nhole:
            hole_pcd = hole_pcd + [pcd[distance_list[i][0]]]
        else:
            partial_pcd = partial_pcd + [pcd[distance_list[i][0]]]
